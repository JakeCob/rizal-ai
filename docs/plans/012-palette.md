...
One web commit and one docs commit, pushed, deployed from the CLI; the tester's production run in light and dark at three widths is recorded in its report. Docs: this plan, D39, tech debt 30 closed and 31 added, the web README.
